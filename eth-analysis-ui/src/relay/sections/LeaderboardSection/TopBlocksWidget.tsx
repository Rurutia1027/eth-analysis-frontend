  ...
  return (
    <WidgetBackground>
      <div className="flex flex-col justify-between">
        ...
        <div
          className={`-mr-3 mt-4 flex h-60 flex-col gap-y-6 overflow-y-auto md:h-64
           ${scrollbarStyles["styled-scrollbar-vertical"]}
           ${scrollbarStyles["styled-scrollbar"]}`}
        >
          {topBlocks.map(({ blockNumber, insertedAt, value }, index) => {
            const age = Format.formatDurationToNow(new Date(), insertedAt);
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-between">
                  <span
                    className={`md:text-md font-roboto text-sm font-light text-slateus-400 hover:opacity-60 lg:text-lg`}
                  >{`${age} ago`}</span>
                  <BaseText
