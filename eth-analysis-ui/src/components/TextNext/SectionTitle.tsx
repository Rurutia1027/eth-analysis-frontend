...
export const SectionTitle: FC<Props> = ({
  ...
  <>
    <div className={`flex items-center justify-center gap-x-4 ${className}`}>
      ...
      >
        <h2
          className={`text-center font-inter text-2xl font-extralight text-white md:text-3xl xl:text-4xl`}
        >
          {children}
          {highlightPhrase && (
            <>
        ...
        {link != undefined && (
          <div className="w-4 md:w-6">
            <WhiteEmoji
              ...
              alt="emoji of a chain link symbolizing a seciton anchor for easy linking"
              name="link"
              width={24}
            />
            <WhiteEmoji
    ...
    {subtitle !== undefined && (
      <p
        className={`mt-6 text-center font-inter text-base font-light text-slate-400 lg:text-lg`}
      >
        {subtitle}
      </p>
    )}
