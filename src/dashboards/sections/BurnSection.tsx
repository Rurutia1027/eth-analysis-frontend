...
const BurnSection: FC<{
 timeFrame: TimeFrame; onClickTimeFrame: OnClick;
 ...
 onSetTimeFrame,
  ...
  return <Section link="burn" subtitle="it's getting hot here" title="burn">
   <div className="p-8 w-full rounded-lg bg-slate-700">
