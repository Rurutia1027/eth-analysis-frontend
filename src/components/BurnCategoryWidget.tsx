...
import { fetchBurnSums, useBurnSums } from "../api/burn-sums";
import { A, flow, N, O, OAlt, OrdM, pipe, RA, Record } from "../utils/fp";
import { FeesBurned, useGroupedAnalysis1 } from "../api/grouped-analysis-1";
import { leaderboardKeyFromTimeFrame } from "../api/leaderboards";
...
export const CategorySegment: FC<CategorySegmentProps> = ({
 imgAlt,
 imgName,
 onHoverCategory,
 percentOfTotalBurn,
 ...
 <div
  ...
  style={ {
   width: `calc(${(percentOfTotalBurn ?? 0.1) * 100}% - ${separatorWidth * separatorCount
    }px)`,
  } }
...
export const CategorySegmentItem: FC<{
