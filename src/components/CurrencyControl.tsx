...
export const CurrencyButton: FC<CurrencyButtonProps> = ({
 onClick,
 selectedUnit,
 unit
}) => (
 <button
  className={ `select-none border px-3 py-2 font-roboto 
...
const CurrencyControl: FC<UnitControlProps> = ({ selectedUnit, onSetUnit }) => (
 <div className="flex flex-row items-center">
  <CurrencyButton onClick={ onSetUnit } selectedUnit={ selectedUnit } unit="eth" />
  <CurrencyButton onClick={ onSetUnit } selectedUnit={ selectedUnit } unit="usd" />
 </div>
);
