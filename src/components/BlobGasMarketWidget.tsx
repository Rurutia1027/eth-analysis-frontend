...
const Marker: FC<MarkerProps> = ({
 ...
 ${vertical === "top" ? "-top-[48px]" : "-bottom-[40px]"}` }
  ...
  >
    { vertical === "bottom" && (
      <div className={ `h-12 w-px rounded-b-full ${markerColor}` }>
      </div>
    ) }
...
const BlobGasMarketWidget: FC<Props> = ({ onClickTimeFrame, timeFrame }) => {
...
export default BlobGasMarketWidget;
