  ...
  return (
    <WidgetBackground className="relative w-full overflow-hidden">
      ...
      <div className="flex flex-row items-center justify-between">
        ...
        <p
          className={`font-inter font-light text-green-400 ${
            copyTextVisible ? "visuble" : "invisible"
          }`}
        >
          copied!
        </p>
      ...
      <div
        className={`
       mb-2 mt-2 flex flex-col items-center justify-between
      ...
      >
        ...
        >
          ...
          <span>@</span>
          <span className="bg-gradient-to-r from-cyan-300 to-indigo-500 bg-clip-text text-transparent">
            {displayAddress.host}
          </span>
        </p>
        <div
